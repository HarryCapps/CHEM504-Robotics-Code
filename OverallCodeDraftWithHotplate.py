...
from Hotplate import IKADriver
...
def main():
    ...
    # Create an instance of the IKADriver with the correct serial port CHANGE THIS TO A COM PORT
    ...
    # Print current stirring speed
    print(driver.getStirringSpeed())

    #Wait 30 seconds whilst stirring
    time.sleep(30)
